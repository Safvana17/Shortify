    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-purple-50 flex flex-col items-center">
        ...
        <div className="mt-10 w-[550px] bg-white rounded-2xl shadow-xl border p-8">
            ...
            <div className="mt-8 space-y-6">
                ...
                />
                <button 
                    className="w-full py-3 rounded-lg text-white font-semibold bg-gradient-to-r from-indigo-500 to-purple-600"
                    onClick={handleLogin}
                >
                    Login
                </button>
                <p className="text-center text-gray-600">
                    Don't have an account? <span className="text-indigo-600" onClick={() => navigate(ROUTES.PUBLIC.SIGNUP)}>Sign up</span>
                </p>
            </div>
        </div>
        <p className="mt-12">
